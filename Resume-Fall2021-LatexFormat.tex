...
{\textbf{Asahi'sDen}} {\sl Node, Express , MongoDB, Handlebars} \\
...
\vspace*{2mm}
{\textbf{nlinks}} {\sl Node, Typescript} \\
...
{\textbf{COVID-Tracker}} {\sl React, Node, MaterialUI, ChartsJS} \\
$\cdot$ Manufactured a COVID-19 Tracker App using React, {\textbf{ChartsJS}}, and {\textbf{MaterialUI}} for the UI Design.\\ $\cdot$ Data is fetched from the COVID-19 API using {\textbf{Async/Await}} syntax and {\textbf{React Hooks}}, and statistics is displayed in cards as well as in charts.\\
\vspace*{2mm}
